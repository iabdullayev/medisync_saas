...
# Root Domain (ALIAS to S3 Redirect)
resource "aws_route53_record" "root" {
  ...
  alias {
    ...
    zone_id                = aws_s3_bucket.root_redirect.hosted_zone_id
    evaluate_target_health = false
  }
}

# Note: The 'www' record is intentionally NOT managed here so you can 
# point it to Streamlit Cloud manually in the AWS Console (CNAME).
